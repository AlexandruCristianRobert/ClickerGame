...
namespace ClickerGame.Upgrades.Domain.ValueObjects
{
    ...
    public record struct BigNumber
    {
        ...
        public static BigNumber operator -(BigNumber left, BigNumber right)
        {
            ...
            if (exponentDiff > 10) return left;
    ...
    public class BigNumberJsonConverter : JsonConverter<BigNumber>
    {
        public override BigNumber Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            var mantissa = jsonObject.GetProperty("mantissa").GetDecimal();
            var exponent = jsonObject.GetProperty("exponent").GetInt32();
        ...
        public override void Write(Utf8JsonWriter writer, BigNumber value, JsonSerializerOptions options)
        {
            ...
            writer.WriteNumber("mantissa", value.ToDecimal());
            writer.WriteNumber("exponent", 0);
